        ...
        <>
            <div className={styles.bg}> 
                ...
                <div >
                    ...
                    <h3 className={styles.reduc}>Reduce your unnecessary usage of commodities such as electricity, water and food. You can take steps such as closing lights and water taps to reduce the production which will then reduce pollution.</h3>
